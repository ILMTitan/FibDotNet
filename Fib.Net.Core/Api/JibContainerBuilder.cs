...
namespace Fib.Net.Core.Api
{
     ...
     *    .addLabel("containerizer", "fib")
     *    .containerize(...);
     * }</pre>
     */
    // TODO: Add tests once containerize() is added.
    public class FibContainerBuilder
    {
        /**
         ...
         *     reference
         */
        public static FibContainerBuilder From(string baseImageReference)
        {
         ...
         * @return a new {@link FibContainerBuilder} to continue building the container
         */
        public static FibContainerBuilder FromScratch()
        {
         ...
         * @return this
         */
        public FibContainerBuilder AddLayer(ILayerConfiguration layerConfiguration)
        {
         ...
         * @return this
         */
        public FibContainerBuilder SetLayers(IEnumerable<ILayerConfiguration> layerConfigurations)
        {
         ...
         * @return this
         */
        public FibContainerBuilder SetLayers(params ILayerConfiguration[] layerConfigurations)
        {
         ...
         * @return this
         */
        public FibContainerBuilder SetEntrypoint(IEnumerable<string> entrypoint)
        {
         ...
         */
        public FibContainerBuilder SetEntrypoint(params string[] entrypoint)
        {
         ...
         * @return this
         */
        public FibContainerBuilder SetProgramArguments(IEnumerable<string> programArguments)
        {
         ...
         */
        public FibContainerBuilder SetProgramArguments(params string[] programArguments)
        {
         ...
         * @return this
         */
        public FibContainerBuilder SetEnvironment(IEnumerable<KeyValuePair<string, string>> environmentMap)
        {
         ...
         * @see #setEnvironment
         */
        public FibContainerBuilder AddEnvironmentVariable(string name, string value)
        {
         ...
         * @return this
         */
        public FibContainerBuilder SetVolumes(IEnumerable<AbsoluteUnixPath> volumes)
        {
         ...
         * @see #setVolumes(ISet)
         */
        public FibContainerBuilder SetVolumes(params AbsoluteUnixPath[] volumes)
        {
         ...
         * @return this
         */
        public FibContainerBuilder SetExposedPorts(IEnumerable<Port> ports)
        {
         ...
         */
        public FibContainerBuilder SetExposedPorts(params Port[] ports)
        {
         ...
         * @see #setExposedPorts(ISet)
         */
        public FibContainerBuilder AddExposedPort(Port port)
        {
         ...
         * @return this
         */
        public FibContainerBuilder SetLabels(IEnumerable<KeyValuePair<string, string>> labelMap)
        {
         ...
         * @return this
         */
        public FibContainerBuilder AddLabel(string key, string value)
        {
         ...
         * @return this
         */
        public FibContainerBuilder SetFormat(ImageFormat imageFormat)
        {
         ...
         * @return this
         */
        public FibContainerBuilder SetCreationTime(DateTimeOffset creationTime)
        {
         ...
         * @return this
         */
        public FibContainerBuilder SetUser(string user)
        {
