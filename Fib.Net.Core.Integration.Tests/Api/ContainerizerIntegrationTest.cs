...
using Fib.Net.Core.Integration.Tests.Registry;
...
{
    // TODO: now it looks like we can move everything here into FibIntegrationTest.
    ...
    public class ContainerizerIntegrationTest : HttpRegistryTest, IDisposable
    {
        ...
        private static void AssertDockerInspect(string imageReference)
        {
            ...
            Assert.That(history, Does.Contain("fib-integration-test"));
