...
{
    public class JibCliConfigurationTests
    {
        [Test]
        public void TestLoadAsync_ThrowsNull()
        {
            var e = Assert.ThrowsAsync<ArgumentNullException>(() => JibCliConfiguration.LoadAsync(null));
            Assert.AreEqual("configFile", e.ParamName);
        }

        [Test]
        public void TestGetTargetImageReference() {
            var config = new JibCliConfiguration
            {
        ...
        public void TestGetContainerBuilder_BaseImage()
        {
            ...
            var cliConfiguration = new JibCliConfiguration
            {
