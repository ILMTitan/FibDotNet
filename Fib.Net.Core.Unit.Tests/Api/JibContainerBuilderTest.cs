...
{
    /** Tests for {@link FibContainerBuilder}. */
    public class FibContainerBuilderTest
    {
        ...
        private readonly Action<IFibEvent> mockFibEventConsumer = Mock.Of<Action<IFibEvent>>();
        private readonly IFibEvent mockFibEvent = Mock.Of<IFibEvent>();
