...
namespace Fib.Net.Core.Unit.Tests.Registry
{
    ...
    public class RegistryEndpointCallerTest : IDisposable
    {
        ...
        public void TearDown()
        {
            ...
            Environment.SetEnvironmentVariable(FibSystemProperties.SendCredentialsOverHttp, null);
        }
        ...
        {
            using (HttpResponseMessage httpResponse = MockHttpResponse(HttpStatusCode.InternalServerError, null))
            {
        ...
        {
            using (HttpResponseMessage errorResponse = MockHttpResponse(httpStatusCode, null))
            {
