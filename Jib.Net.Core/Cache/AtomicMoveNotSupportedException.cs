...
{
    [Serializable]
    internal class AtomicMoveNotSupportedException : Exception
    {
        ...
        protected AtomicMoveNotSupportedException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
    }
}